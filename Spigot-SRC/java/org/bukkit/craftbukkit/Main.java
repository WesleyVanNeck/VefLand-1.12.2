    ...
    public static void main(String[] args) {
        ...
        if ((options == null) || (options.has("?"))) {
            ...
            try {
                ...
                System.err.println("*** VefLand 已为您屏蔽掉烦人的构建过期提示 ***");
                System.err.println("*** 您当然可以下载新版本 http://www.relatev.com/forum.php?mod=viewthread&tid=45 ***");
                System.err.println("*** 服务器会立即进行开启 ***");
                Thread.sleep(TimeUnit.SECONDS.toMillis(1));

                System.out.println("正在加载资源文件，稍等...");
                System.out.println("A resource file is being loaded, wait a minute...");
                
                MultiThreadConcurrent.init();
                MultiSecondaryThread.init();
